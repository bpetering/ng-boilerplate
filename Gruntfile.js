module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    sass: {                                 // Task
        ...
        compile: {
          // src should not match recess (='dest'). recess does
          // minification differently - here, use style: compressed
          src: '<%= sass.build.src %>',
  ...
  grunt.registerTask( 'compile', [
    'sass:compile', 'copy:compile_assets', 'ngmin', 'concat', 'uglify', 'index:compile'
  ]);
